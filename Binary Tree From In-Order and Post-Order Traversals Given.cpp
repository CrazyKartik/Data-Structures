...
While Traversing in Post-Order we go to left then right then root , so to construct we do opposite , i.e,
We make root then we make right then at last we make left part.
Similarly for checking the validity of the given traversals.
*/
