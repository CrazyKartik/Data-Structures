...
When we traverse the tree in Pre-Order we go to root then to the left then to the right.
To Construct the tree we do the same i.e, First we make root then the left sub-part then the right sub-part.
Similarly We check for the validity of the given traversals.
*/
